var objBirthPlaceprovince=document.getElementById("birthplaceProvince");
var objBirthPlacecity=document.getElementById("birthplaceCity");
...
objBirthPlaceprovince.onchange=function GetBirthPlaceCity(){
    var x=this.selectedIndex-1;
    for(var i=0;i<objBirthPlacecity.length;i++)
    {
        objBirthPlacecity.remove(i);
    }
    ...
    if(x>=0)
    {
        ...
        {
            objBirthPlacecity.options[i]=new Option(citylist[i],citylist[i]);
        }
    }
    else
    {
        objBirthPlacecity.options[0]=new Option("请选择城市","请选择城市");
    }
};
function GetBirthPlaceProvince()
{
    objBirthPlaceprovince.options[0]=new Option("请选择省份","请选择省份");
    for(var i=0;i<parray.length;i++)
    {
        objBirthPlaceprovince.options[i+1]=new Option(parray[i],parray[i]);
    }
}
window.onload=GetBirthPlaceProvince();