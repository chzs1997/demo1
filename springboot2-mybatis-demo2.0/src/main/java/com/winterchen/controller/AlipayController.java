...
import com.winterchen.conf.AlipayConfig;
import com.winterchen.util.RandomUtils;
...
public class AlipayController {
     ...
     */
    @RequestMapping("/pay")
    public void pay(HttpServletRequest request, HttpServletResponse response,int userId,String money) throws Exception {

        // 模拟从前台传来的数据
        String orderNo = RandomUtils.createRandomString(15); // 生成订单号
